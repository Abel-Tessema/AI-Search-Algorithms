    ...
    def __init__(self, master):
        ...
        for i, alg in enumerate(uninformed_alg_list, start=1):
            ctk.CTkButton(
                self,
                text=alg,
                command=lambda alg=alg: self.button_clicked(alg)
        ...
        # Credits button
        self.credits_button = ctk.CTkButton(self, text='Credits')
        self.credits_button.grid(row=len(uninformed_alg_list) + 4, column=0, padx=20, pady=5, sticky='ws')
